...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "Пожалуйста, введите еще раз.",
		...
		rangelength: $.validator.format( "Пожалуйста, введите значение от {0} до {1} знаков." ),
		...
		step: $.validator.format( "Пожалуйста, введите значение, кратное {0}." )
	},
